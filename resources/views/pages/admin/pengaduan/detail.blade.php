    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto">
        ...
        <div
          ...
          <h2 class="mt-4">Tanggal : {{ $item->created_at->locale('id')->isoFormat('dddd, D MMMM YYYY - HH:mm:ss') }}</h2>
        ...
        <div class="px-4 py-3 mb-8 flex text-gray-800 bg-white rounded-lg shadow-md dark:bg-gray-800">
          <div class="relative hidden mr-3  md:block dark:text-gray-400">
            ...
            <img class="h-auto w-auto max-h-64 max-w-sm rounded-lg" src="{{ asset('storage/' . $item->image) }}" alt="" loading="lazy" />
          </div>
